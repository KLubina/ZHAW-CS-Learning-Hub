window.StudiengangModuleDetails = {
  ...
  "Diskrete Mathematik": {
    kurzbeschreibung:
      "Mathematische Grundkenntnisse und Einführung in die diskrete Mathematik",
    inhalt:
  ...
  "Communication Competence Basic": {
    kurzbeschreibung:
      "Grundlegende Kompetenzen für wissenschaftliches Arbeiten und Kommunikation",
    inhalt:
  ...
  "Wahlpflichtmodul Kommunikation": {
    ...
    inhalt:
      "Sie haben die Möglichkeit, aus einem Portfolio verschiedener Kommunikationsmodule zu wählen.",
    link: "",
  },
  // #endregion
  ...
  "Software-Projekt 3": {
    kurzbeschreibung:
      "Entwicklung eines grösseren und komplexeren Softwaresystems",
    inhalt:
  ...
  "Software-Entwicklung 1": {
    kurzbeschreibung:
      "Analyse- und Entwurfs-Kompetenzen für komplexere Softwaresysteme",
    inhalt:
      "► Analyse\n" +
      "• Use Cases\n" +
      "• Domänenmodellierung\n" +
  ...
  "Projektarbeit in Informatik": {
    kurzbeschreibung:
      "Selbstständige Bearbeitung einer praxisorientierten technisch-wissenschaftlichen Aufgabenstellung",
    inhalt:
  ...
  "Bachelorarbeit in Informatik": {
    kurzbeschreibung:
      "Selbstständige Bearbeitung einer praxisnahen technisch-wissenschaftlichen Fragestellung",
    inhalt:
      "► Selbständige Arbeit\n" +
