...
if (window.HSLUEITStudienplan) {
    ...
    window.HSLUEITStudienplan.prototype.createYearSection = function(year) {
        if (year === 3) {
    ...
    window.HSLUEITStudienplan.prototype.createThirdYearSection = function() {
    ...
    window.HSLUEITStudienplan.prototype.createCategoryBasedThirdYear = function(container) {
